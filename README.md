...
[![unit tests](https://img.shields.io/github/actions/workflow/status/AnderssonPeter/PowerType/test.yml?branch=main&style=flat-square)](https://github.com/AnderssonPeter/PowerType/actions/workflows/test.yml)
